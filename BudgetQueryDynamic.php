...
<head>
    ...
    <link rel="stylesheet" href="./css/gis/BudgetQueryDynamic.css?<?php echo filemtime('./css/gis/BudgetQueryDynamic.css') ?>" />
...
<body>
                ...
                <div class="row" style="width: 70vw;">
                    ...
                    <div class="col-md-9">
                        ...
                        <div id="user-list">
                            <div class="row">
                                <div class="col">
                                    <div id="queryHeader" class="title">Budget Allocation</div>
                                    <div id="queryTable" class="details"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="./js/gis/BudgetQueryDynamic.js?<?php echo filemtime('./js/gis/BudgetQueryDynamic.js') ?>" type="text/javascript"></script>
