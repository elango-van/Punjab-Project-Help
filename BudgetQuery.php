...
<head>
    ...
    <link rel="stylesheet" href="./css/gis/BudgetQuery.css?<?php echo filemtime('./css/gis/BudgetQuery.css') ?>" />
...
<body>
        ...
        <section class="about_section layout_padding">
            ...
            <div class="container">
                <div class="row" style="width: 70vw;">
                    <div class="col-md-3">
                        <!-- <div class="detail-box pr-md-2"></div> -->
                    ...
                    <div class="col-md-9">
                        <div id="list-header">Chart and Table</div>
                        <div id="user-list">
                            <div class="row">
                                <div class="col">
                                    <div id="columnheader" class="title"></div>
                                    <div id="columnchart"></div>
                                </div>
                                <div class="col">
                                    <div id="pieheader" class="title"></div>
                                    <div id="piechart"></div>
                                </div>
                            </div>
                            <hr>
                            <!-- <div class="row">
                                <div class="col">
                                    <div id="caheader" class="title"></div>
                                    <div id="cachart"></div>
                                </div>
                                <div class="col">
                                    <div id="natureheader" class="title"></div>
                            ...
                            <div class="row">
                                <div class="col h-100 overflow-auto">
                                    <div id="queryheader" class="title"></div>
    ...
    <script src="./js/gis/BudgetQuery.js?<?php echo filemtime('./js/gis/BudgetQuery.js') ?>" type="text/javascript"></script>
