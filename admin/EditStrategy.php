...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['strategycode']) && isset($_POST['method'])) {
    ...
    if (empty($strategycode) || empty($method)) {
        $errors[] = "Strategy does not exist";
    } else {
        ...
        if ($conn->connect_error) {
            ...
            $stmt = $conn->prepare("SELECT * FROM strategies WHERE strategycode = ?");
...
<body>
                        ...
                        <div id="user-form">
                            <div class="form-fill">
                                ...
                                <form method="post" id="alter-form" onsubmit="return validateForm()">
                                    <input type="text" name="strategycode" id="strategycode" hidden value="<?php echo htmlspecialchars($strategycode); ?>" required>
                                    <input type="text" name="method" id="method" hidden value="<?php echo htmlspecialchars($method); ?>" required>
                                    <div class="mb-3">
                                        <label for="strategyname" class="form-label">Strategy Name <label class="field-required">*</label></label>
                                        <input type="text" class="form-control" name="strategyname" id="strategyname" placeholder="Strategy Name" value="<?php echo htmlspecialchars($strategyname); ?>" required>
                                    </div>
                                    <?php if (!empty($errors)) { ?>
    ...
    <script>
        function validateForm() {
            var strategycode = document.forms["alter-form"]["strategycode"].value;
            var method = document.forms["alter-form"]["method"].value;
            var strategyname = document.forms["alter-form"]["strategyname"].value;


            // console.log([strategycode, method, name, email, department, role]);
